...
namespace CryptoNote {
	namespace parameters {
		...
		const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x1c7cec;
		...
		const uint64_t MONEY_SUPPLY = UINT64_C(7000000000000000000);
		const uint32_t ZAWY_DIFFICULTY_BLOCK_INDEX = 0;
		const size_t ZAWY_DIFFICULTY_V2 = 0;
		const uint8_t ZAWY_DIFFICULTY_DIFFICULTY_BLOCK_VERSION = 0;
		const unsigned EMISSION_SPEED_FACTOR = 18;
		const uint64_t GENESIS_BLOCK_REWARD = UINT64_C(210000000000000000);
	...
	const char     CRYPTONOTE_NAME[] = "godtoken";
	...
	const int      RPC_DEFAULT_PORT = 5365;
	...
	const std::initializer_list<CheckpointData> CHECKPOINTS = {
		//{ 8297, "3d9e7e145369a566ecf8dfd9bf1527c2f94da522a173bdfa76a39269417c99ea" }
	};
} // CryptoNote
